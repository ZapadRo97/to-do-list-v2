...
ListTemplate<ListType>::ListTemplate(string name, int noItems)
{
    this->name = name;
...
template <class ListType>
void ListTemplate<ListType>::AddListItem(int index, string text)
{
...
template <class ListType>
void ListTemplate<ListType>::AddListItem(int index, string text, Date reminder_date)
{
